const knowledge: { q: string[]; a: string }[] = [
  ...
  {
    q: ['wallet', 'connect', 'algorand', 'network', 'testnet'],
    a: 'Connect your Algorand wallet (Pera or Defly) on Algorand Testnet. If transactions are pending, check network congestion or try again later.'
  },
  {
    q: ['admin', 'role', 'access'],
