    ...
    <div className="w-full max-w-md mx-auto">
      <div className="glass p-8 rounded-xl border border-white/10">
        <div className="text-center mb-6">
          ...
          <p className="text-white/70">Join the digital identity platform</p>
        </div>
        ...
        <div className="mt-4 text-xs text-white/50 text-center">
          <div>🔒 Your data is processed securely</div>
          <div>🌐 No personal information is stored locally</div>
          <div>⚡ Powered by Firebase Authentication</div>
        </div>
      </div>
    </div>
  )
