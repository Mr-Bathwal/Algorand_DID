        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="flex gap-3">
              <button type="button" className="px-4 py-2 bg-brand-600 hover:bg-brand-700 rounded-md text-sm font-medium transition-colors">
                Take Survey
              </button>
              <button type="button" className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-md text-sm font-medium transition-colors">
                View Results
              </button>
            </div>
          </div>
