    ...
    return (
      <div className="glass p-4 rounded-lg border border-white/10">
        ...
        <div className="text-sm">This area is restricted to authorized administrators. If you believe this is a mistake, please contact your administrator.
          <button type="button" className="ml-2 underline" onClick={()=>window.dispatchEvent(new CustomEvent('open-chat',{detail:{message:'I need admin access help'}}))}>Talk to assistant</button>
        </div>
      </div>
    )
  }
